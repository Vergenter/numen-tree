...
class DAGSN_tier_up_test(unittest.TestCase):
    ...
    def test_tier_up_to_tier_3(self):
        g1 = repeat(DAGSN(), DAGSN.add_node_to_tier_1,
                    4).tier_up(0, 1).tier_up(2, 3)
    ...
    def test_tier_up_move_correctly(self):
        ...
        number_of_tier_up = 3
        self.assertTrue(all(
            node == 0 for node in g1.nodes[g1.tier_bounds[tier]:g1.tier_bounds[tier]+number_of_tier_up]))
    ...
    def test_tier_up_bases_for_tier3(self):
        ...
        self.assertEqual(g1.nodes[6] & 0b1111111, 0b111111)

    def test_only_tier_up(self):
...
class DAGSN_canonical(unittest.TestCase):
    ...
    def test_get_canonical_form_1(self):
        g1 = DAGSN().add_node_to_tier_1().add_node_to_tier_1().tier_up(
    ...
    def test_get_canonical_form_9(self):
        g1 = repeat(DAGSN(), DAGSN.add_node_to_tier_1, 4)\
            .tier_up(0, 1).tier_up(0, 1).tier_up(2, 3).tier_up(2, 3)
...
class DAGSNTest(unittest.TestCase):
    ...
    def test_extend(self):
        g1 = DAGSN().add_node_to_tier_1().add_node_to_tier_1()\
            ...
            .add_node_to_tier_1()\
            .extend(4, 3)
        self.assertTrue(g1.nodes[g1.tier_bounds[1]] >
                        0 and g1.nodes[g1.tier_bounds[1]+1] == 0)
        with self.assertRaises(ValueError):
    ...
    def test_get_tier(self):
        g1 = DAGSN().add_node_to_tier_1().add_node_to_tier_1().tier_up(
            0, 1).add_node_to_tier_1().extend(3, 2).add_node_to_tier_1().extend(4, 3)
